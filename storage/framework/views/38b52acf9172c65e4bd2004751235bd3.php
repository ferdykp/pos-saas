    ...
    <div class="grid grid-cols-2 gap-3 lg:grid-cols-4 sm:gap-4">
        ...
        <div class="p-3.5 rounded-lg border border-border-200 bg-surface-100/50 flex flex-col justify-between">
            ...
            <strong class="text-base font-bold sm:text-lg text-ink-900">
                Rp <?php echo e(number_format($cashSummary['receipts'], 0, ',', '.')); ?>
        ...
        <div class="p-3.5 rounded-lg border border-border-200 bg-surface-100/50 flex flex-col justify-between">
            ...
            <strong class="text-base font-bold sm:text-lg text-ink-900">
                Rp <?php echo e(number_format($cashSummary['refunds'], 0, ',', '.')); ?>
        ...
        <div class="p-3.5 rounded-lg border border-border-200 bg-surface-100/50 flex flex-col justify-between">
            ...
            <strong class="text-base font-bold sm:text-lg text-ink-900">
                Rp <?php echo e(number_format($cashSummary['expenses'], 0, ',', '.')); ?>
        ...
        <div class="p-3.5 rounded-lg border border-border-200 bg-surface-100/50 flex flex-col justify-between">
            ...
            <strong
                class="text-base sm:text-lg font-bold <?php echo e($cashSummary['net'] >= 0 ? 'text-semantic-success' : 'text-semantic-danger'); ?>">
                Rp <?php echo e(number_format($cashSummary['net'], 0, ',', '.')); ?>
...
<?php /**PATH /Users/ferdy/project-fl/pos-saas/resources/views/reports/partials/cash-summary.blade.php ENDPATH**/ ?>