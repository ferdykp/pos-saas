<header
    ...
    <div class="flex items-center flex-1 gap-3">
        ...
        <a href="<?php echo e(route('getting-started')); ?>" class="hidden md:flex text-sm font-semibold text-primary-600">Mulai berjualan →</a>
    </div>
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('billing.index')); ?>"
            ...
            <?php if($activeSub && $activeSub->plan): ?>
                ...
                <span class="text-primary-800 font-heading"><?php echo e($activeSub->plan->name); ?></span>
            <?php else: ?>
        ...
        <div class="relative" x-data="{ userMenu: false }">
            <button @click="userMenu = !userMenu"
                ...
                <div class="flex-col hidden text-left xl:flex">
                    <span class="text-xs font-semibold leading-tight text-ink-900"><?php echo e(auth()->user()->name); ?></span>
                    <span class="text-[10px] font-medium text-ink-700 leading-tight">
                        <?php echo e(auth()->user()->role === 'admin' ? 'Superadmin' : auth()->user()->tenant->name ?? 'Kasir Store'); ?>
            ...
            <div x-show="userMenu" @click.away="userMenu = false" x-transition:enter="transition ease-out duration-150"
                ...
                <div class="px-3 py-2 mb-1 border-b border-border-200">
                    <p class="text-xs font-semibold truncate text-ink-900"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-[11px] text-ink-700 truncate"><?php echo e(auth()->user()->email); ?></p>
                </div>
...
<?php /**PATH /Users/ferdy/project-fl/pos-saas/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>