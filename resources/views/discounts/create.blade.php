<x-app-layout>
    <div class="max-w-4xl p-6 mx-auto bg-white shadow-xl rounded-2xl">
        ...
        <form action="{{ route('discounts.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                <label class="block mb-2 text-sm font-bold text-gray-700">Pilih Menu / Produk Yang Terkena
                    Diskon</label>
                <div
            ...
            <div class="flex justify-end gap-3">
                ...
                <div class="flex items-center justify-between p-4 border border-blue-100 bg-blue-50 rounded-xl">
                    <div>
                        ...
                        <p class="text-xs font-medium text-blue-700">Jika tidak dicentang, diskon tidak akan muncul di
                            POS.</p>
                    </div>
