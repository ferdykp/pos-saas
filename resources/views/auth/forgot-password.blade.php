        ...
        <div class="flex flex-col justify-center w-full px-8 py-12 bg-surface-0 md:px-12 lg:px-20">
            <div class="w-full max-w-md mx-auto">
                ...
                <div
                    ...
                    <x-icon class="text-2xl fa-solid fa-lock-open" />
                </div>
                ...
                @if (session('status'))
                    <div
                        ...
                        <x-icon class="text-base fa-solid fa-circle-check text-emerald-600 shrink-0" />
                    ...
                    <form method="POST" action="{{ route('password.email') }}" class="space-y-5"
                        ...
                        <div class="pt-2">
                            <button type="submit" :disabled="isSubmitting"
                                ...
                                <x-icon x-show="!isSubmitting" class="mr-2 text-xs fa-solid fa-paper-plane" />
                                <span
