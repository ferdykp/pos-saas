<x-app-layout>
    ...
    <div class="w-full px-4 py-5 mx-auto md:px-6 lg:px-8 xl:px-10 2xl:px-12 max-w-[1680px]">
        <!-- Header & Navigation -->
        <div class="mb-6">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-1 gap-5 xl:grid-cols-2 xl:items-start">
                ...
                <div class="p-4 border rounded-lg shadow-sm sm:p-5 xl:p-6 bg-surface-0 border-border-200">
                    ...
                    <div class="mb-6">
                        ...
                        <label id="preview-container"
                            class="relative flex flex-col items-center justify-center w-full overflow-hidden transition-colors border-2 border-dashed rounded-md cursor-pointer h-36 2xl:h-40 border-border-200 bg-surface-100/50 hover:bg-surface-100">
                            <div id="upload-placeholder"
                                ...
                                <p class="text-xs font-semibold font-body text-ink-900">Klik atau drag foto produk ke
                                    sini
                                </p>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="type" id="type_select"
                                ...
                                <option value="product" @selected(old('type', auth()->user()->tenant->businessType() === 'service' ? 'service' : 'product') === 'product')>Barang Fisik (Stok Dihitung)
                                </option>
                ...
                <div class="p-4 border rounded-lg shadow-sm sm:p-5 xl:p-6 bg-surface-0 border-border-200">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        @if (auth()->user()->tenant->hasBusinessModule('food'))
                            <label class="block my-4"><input type="checkbox" name="requires_preparation" value="1"
                                    @checked(old('requires_preparation', auth()->user()->tenant->businessType() === 'food'))> Kirim barang ini ke dapur / bar setelah
                                pembayaran</label>
                        @endif
                        <div id="manage_stock_container"
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <h4 class="text-xs font-semibold font-heading text-ink-900">Lacak Ketersediaan Stok
                                    </h4>
                                    <p class="font-body text-[11px] text-ink-400 mt-0.5">Nonaktifkan jika barang
                                        diproduksi
            ...
            <!-- Submit Section -->
            <div
                class="sticky bottom-0 z-20 flex flex-col gap-3 p-4 border rounded-lg shadow-sm sm:flex-row sm:items-center sm:justify-between bg-white/95 backdrop-blur border-border-200">
